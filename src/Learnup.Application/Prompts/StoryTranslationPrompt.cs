...
public static class StoryTranslationPrompt
{
    public static string GetPrompt()
    {
        return """
               You are helping Farsi speakers learn English through short stories.
               You are given the full story as an ordered list of sentences. Each sentence has an
               "Order" number and its English "Content".

               Translate the story sentence by sentence, but use the surrounding sentences as context
               so that pronouns, tense, tone and formality (informal تو vs formal شما) are consistent
               and natural across the whole story.

               For each sentence do two things:

               1. Translate it into natural, fluent Farsi, taking the whole story into account.
