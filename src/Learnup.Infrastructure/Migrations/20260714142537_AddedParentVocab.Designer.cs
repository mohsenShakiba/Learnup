...
namespace Learnup.Infrastructure.Migrations
{
    ...
    [Migration("20260714142537_AddedParentVocab")]
    partial class AddedParentVocab
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Learnup.Domain.AggregateRoots.AudioBooks.AudioBookListItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AudioBookListItem", (string)null);
                });

            modelBuilder.Entity("Learnup.Domain.AggregateRoots.AudioBooks.AudioBookListItemExpression", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("AudioBookListItemId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AudioBookListItemId");

                    b.ToTable("AudioBookListItemExpression", (string)null);
                });

            modelBuilder.Entity("Learnup.Domain.AggregateRoots.AudioBooks.AudioBooks", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("TimingJsonId")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("Learnup.Domain.AggregateRoots.Placement.PlacementOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("PlacementQuestionId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PlacementOption", (string)null);
                });

            modelBuilder.Entity("Learnup.Domain.AggregateRoots.Placement.PlacementQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Learnup.Domain.AggregateRoots.Users.User", b =>
                {
                    ...
                    b.Property<int>("AvailableLessonCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("UsedLessonCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Learnup.Domain.AggregateRoots.Users.UserPlacementAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("UserPlacementResultId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("UserPlacementResultId");

                    b.ToTable("UserPlacementAnswer", (string)null);
                });

            modelBuilder.Entity("Learnup.Domain.AggregateRoots.Users.UserPlacementResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("UserPlacementResult", (string)null);
                });
            ...
            modelBuilder.Entity("Learnup.Domain.AggregateRoots.Users.UserTokenUsage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<long>("TotalTokensHistoryUsage")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Learnup.Domain.AggregateRoots.Vocabularies.Vocab", b =>
                {
                    ...
                    b.Property<string>("ParentVocabDescription")
                        .HasMaxLength(512)
            ...
            modelBuilder.Entity("Learnup.Domain.AggregateRoots.Vocabularies.VocabSense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Learnup.Domain.AggregateRoots.AudioBooks.AudioBookListItem", b =>
                {
                    b.HasOne("Learnup.Domain.AggregateRoots.AudioBooks.AudioBooks", "AudioBook")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Learnup.Domain.AggregateRoots.AudioBooks.AudioBookListItemExpression", b =>
                {
                    b.HasOne("Learnup.Domain.AggregateRoots.AudioBooks.AudioBookListItem", "AudioBookListItem")
                        .WithMany("Expressions")
                        .HasForeignKey("AudioBookListItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AudioBookListItem");
                });
            ...
            modelBuilder.Entity("Learnup.Domain.AggregateRoots.Placement.PlacementOption", b =>
                {
                    b.HasOne("Learnup.Domain.AggregateRoots.Placement.PlacementQuestion", null)
                        .WithMany("Options")
            ...
            modelBuilder.Entity("Learnup.Domain.AggregateRoots.Placement.PlacementQuestion", b =>
                {
                    b.HasOne("Learnup.Domain.AggregateRoots.Placement.PlacementTest", null)
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("Learnup.Domain.AggregateRoots.Users.UserPlacementAnswer", b =>
                {
                    b.HasOne("Learnup.Domain.AggregateRoots.Users.UserPlacementResult", null)
                        .WithMany("Answers")
                        .HasForeignKey("UserPlacementResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
