    ...
    : DbContext(options), ILearnupDbContext
{
    ...
    public DbSet<UserPlacementResult> UserPlacementResults => Set<UserPlacementResult>();
    public DbSet<UserPlacementAnswer> UserPlacementAnswers => Set<UserPlacementAnswer>();
